...
<body>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="text1" name="uts" type="number" class="form-control" min="0" max="100" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="text2" class="col-4 col-form-label"><b>Nilai UAS</b></label> 
    <div class="col-8">
      <input id="text2" name="uas" type="number" class="form-control" min="0" max="100" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="text3" class="col-4 col-form-label"><b>Nilai Tugas/Praktikum</b></label> 
    <div class="col-8">
      <input id="text3" name="tugas" type="number" class="form-control" min="0" max="100" required>
    </div>
  </div> 
  <div class="form-group row">
    <div class="offset-4 col-8">
      <button name="submit" type="submit" class="btn btn-primary" required>Submit</button>
    </div>
  </div>
</form>
            </div>
